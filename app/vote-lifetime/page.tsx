...
export default function VoteLifetimePage() {
  ...
  useEffect(() => {
    ...
    const hasVoted = localStorage.getItem("hasVoted_lifetime_achievement");
    if (hasVoted === "true") {
      setAlreadyVoted(true);
    }
    
    const savedVote = localStorage.getItem("vote_lifetime_achievement");
    if (savedVote) {
  ...
  const handleVoteChange = (nominee: string) => {
    ...
    localStorage.setItem("vote_lifetime_achievement", nominee);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        localStorage.setItem("hasVoted_lifetime_achievement", "true");
        localStorage.removeItem("vote_lifetime_achievement");
        setSubmitted(true);
