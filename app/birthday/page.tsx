    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 overflow-hidden">
        ...
        <div className="relative z-10 text-center animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-pink-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent animate-gradient">
            Birthday Registered!
          </h1>
          ...
          <button
            ...
            className="px-8 py-4 bg-gradient-to-r from-pink-500 via-orange-500 to-yellow-500 text-white font-bold text-lg rounded-2xl hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-pink-500/50"
          >
            Register Another Birthday
          </button>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-yellow-500/20 rounded-full blur-3xl animate-pulse-slow" />
        </div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-16">
        ...
        <div className="text-center mb-12 animate-slide-down">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-4 bg-gradient-to-r from-pink-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent animate-gradient">
          ...
          <p className="text-lg text-pink-300/80 max-w-2xl mx-auto">
            Let us celebrate you on your special day!
          </p>
        </div>
